...
const Home = () => {
      ...
      fetch("/static/media/gym_coordinates.e039c3ed6528dac26057.geojson")
        ...
        .then((data) => {
          ...
          data.features.forEach((feature) => {
            ...
            ); // Assuming the name is stored in the 'name' property
    ...
    if (showBart) {
      if (bartMode === "Walking") {
        opacityExpression = [
          "-",
          opacityExpression,
          ["*", ["get", "walking_bart_score"], 0.1],
        ];
      } else {
        opacityExpression = [
          "-",
          opacityExpression,
          ["*", ["get", "driving_bart_score"], 0.1],
        ];
      }
    }
    if (showBudget) {
  ...
  useEffect(() => {
    ...
    map.current.on("load", () => {
      ...
      map.current.on(
        "mouseenter",
        ["neighborhood-fill", "quadrant-fill"],
        (e) => {
      ...
      map.current.setPaintProperty(
        ...
        showQuadrantColors
          ? [
              ...
              ["get", "quad"],
              "SE",
              "rgba(144, 238, 144, 0.7)", // lightgreen with 0.7 opacity
              "SW",
              "rgba(255, 165, 0, 0.7)", // orange with 0.7 opacity
              "NE",
              "rgba(0,51,204,0.7)", // blue with 0.7 opacity
              "NW",
              "rgba(255, 0, 0, 0.7)", // red with 0.7 opacity
  ...
  return (
    <>
      <div
        className={`${
          showInfo ? " opacity-50" : "opactiy-100"
        }  bg-white flex h-screen w-screen overflow-hidden`}
      ...
      >
        ...
        <div className="xl:w-1/4 w-1/2 h-screen overflow-y-scroll">
          <div
            style={{ width: "100%" }}
            className="bg-blue-100 xl:border-b-8 border-b-4 border-blue-900 xl:p-3 p-1 flex items-center justify-center"
          >
            <img
              src={logo}
              alt="logo"
              className="2xl:w-10 2xl:h-10 xl:w-8 xl:h-8 lg:w-8 lg:h-8 md:w-6 md:h-6 w-4 h-4"
            />
            ...
            <p
              className="lg:border-2 sm:border-1 border-0.5 rounded-full justify-center items-center flex ml-2 xl:-mt-4 lg:-mt-2 
          ...
          <div className="flex flex-col xl:py-4 xl:px-3 py-2 px-1">
            ...
            <h3 className="mb-1 text-gray-600 subTitle2">
            ...
            <div className="grid grid-cols-1 grid-flow-row lg:gap-2 sm:gap-1 gap-0.5 xl:border-b-4 border-b-2 border-blue-900 bodyText">
              <div
                ...
                className={`lg:w-8/12 w-fit whitespace-nowrap xl:py-2 xl:px-3 lg:py-1 lg:px-2 py-0.25 px-1.5 md:border-2 border-1 border-gray-300 ${
                  showCrime
                    ? "bg-gray-100 cursor-not-allowed opacity-50"
                    : "opacity-100 hover:bg-gray-100 bg-white cursor-pointer"
                } rounded-lg flex items-center duration-200`}
              >
                <BsShield className="xl:w-4 xl:h-4 w-2 h-2 mx-1" />
                Safety
              </div>
              <div
                onClick={() => setShowGyms(true)}
                className={` lg:w-8/12 w-fit  whitespace-nowrap xl:py-2 xl:px-3 lg:py-1 lg:px-2 py-0.25 px-1.5 md:border-2 border-1 border-gray-300 ${
                  showGyms
                    ? "bg-gray-100 cursor-not-allowed opacity-50"
                    : "opacity-100 hover:bg-gray-100 bg-white cursor-pointer"
              ...
              >
                <CiDumbbell className="xl:w-4 xl:h-4 w-2 h-2 mx-1" />
                Gyms
              </div>
              <div
              ...
              >
                <BsTree className="xl:w-4 xl:h-4 w-2 h-2 mx-1" />
                Parks
              </div>
              ...
              >
                <FiShoppingCart className="xl:w-4 xl:h-4 w-2 h-2 mx-1" />
                Grocery Chains
              </div>
              <div
                onClick={() => setShowBart(true)}
                className={` lg:w-8/12 w-fit  whitespace-nowrap xl:py-2 xl:px-3 lg:py-1 lg:px-2 py-0.25 px-1.5 md:border-2 border-1 border-gray-300 ${
                  showBart
                    ? "bg-gray-100 cursor-not-allowed opacity-50"
                    : "opacity-100 hover:bg-gray-100 bg-white cursor-pointer"
              ...
              >
                <BsTrainFront className="xl:w-4 xl:h-4 w-2 h-2 mx-1" />
                BART Stations
              </div>
              <div
              ...
              >
                <BiMoneyWithdraw className="xl:w-4 xl:h-4 w-2 h-2 mx-1" />
                Budget
              </div>
              <div
                onClick={() => setShowBikes(true)}
                className={`mb-2 lg:w-8/12 w-fit  whitespace-nowrap xl:py-2 xl:px-3 lg:py-1 lg:px-2 py-0.25 px-1.5 md:border-2 border-1 border-gray-300 ${
                  showBikes
                    ? "bg-gray-100 cursor-not-allowed opacity-50"
                    : "opacity-100 hover:bg-gray-100 bg-white cursor-pointer"
                } rounded-lg flex items-center   duration-200`}
              >
                <PiPersonSimpleBikeBold className="xl:w-4 xl:h-4 w-2 h-2 mx-1" />
                BikeShare
              </div>
            </div>

            <div className="flex flex-col">
              <h1 className=" text-gray-900 font-semibold subTitle">Filters</h1>
              <h2 className="text-gray-600 subTitle2">Click to delete</h2>
        ...
        <div className="" style={{ width: "100%" }}>
          ...
          <div className="absolute bottom-8 right-2 z-10 flex flex-col">
            <button
              ...
              onClick={() => {
                setShowQuadrantColors(!showQuadrantColors);
              }}
            >
              {showQuadrantColors
                ? "Hide Quadrant Colors"
      ...
      {showInfo ? (
        <div className="absolute opacity-100 left-0 right-0 mx-auto about-container">
          <div class="lg:text-sm text-xs bg-white pb-16  md:px-8 px-4 rounded-md">
            ...
            Bayborhood helps you discover suitable neighborhoods in San
            Francisco, based on your preferences.
            <ul class="list-decimal ml-6 text-sm">
              ...
              <li class="mt-1">
                ...
                add filters. Darker areas indicate higher alignment with your
                preferences. You can hover over a neighborhood to see its name
                and the quadrant it's in.
              </li>
              <li class="mt-1">
                <b>See Quadrants</b>: On the bottom right, toggle "See
                Quadrants" to color-coordinate the map to color every
                neighborhood separately by their quadrant.
              </li>
            </ul>
            ...
            <ul class="ml-6 list-disc">
              <li class="mt-1">
                <b>Neighborhoods and Quadrants</b>: 2022 Neighborhood Analysis{" "}
                <a
              ...
              <li class="mt-1">
                <b>Grocery Chains and Gyms</b>:{" "}
                <a
                  href="https://developer.foursquare.com/docs/places-api-overview"
                  target="_blank"
                  rel="noreferrer"
                  class="text-blue-500 underline"
                >
              ...
              <li class="mt-1">
                <b>BART Stations</b>:{" "}
                <a
                  href="https://www.bart.gov/schedules/developers/api"
                  target="_blank"
                  rel="noreferrer"
                  class="text-blue-500 underline"
                >
                ...
                <a
                  href="https://www.microsoft.com/en-us/maps/bing-maps/distance-matrix"
                  target="_blank"
                >
                  Bing Distance API
                </a>
              ...
              <li class="mt-1">
                <b>Housing Prices</b>:{" "}
                <a
                  href="https://developers.rentcast.io/reference/market-statistics"
                  target="_blank"
                  rel="noreferrer"
                  class="text-blue-500 underline"
                >
          ...
          >
            ...
            <div className="grid grid-cols-2 lg:gap-2 gap-1">
              <div
                ...
                } duration-100 text-center md:border-2 border rounded-lg xl:px-2 px-0.5 py-1 cursor-pointer bodyText2`}
              >
                Trader Joe's
              </div>
              <div
              ...
              <div
                ...
                className={`${
                  bartMode === "Walking"
                    ? "bg-blue-500 border-blue-200"
                    : "bg-white border-gray-500"
                } duration-100 text-center md:border-2 border rounded-lg xl:px-2 px-0.5 py-1 cursor-pointer 2xl:text-md bodyText2`}
              >
                Walking
              </div>
              <div
            ...
            >
              <div class="slidecontainer">
                ...
                <div className="flex flex-col py-2 px-2 bg-gray-50 rounded-lg w-full mx-auto border-0.5 border-black">
                  <p className="">Average Monthly Rent: </p>
